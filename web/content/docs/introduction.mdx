...
See transport-agnostic wiring in [Overview](/overview/), and iframe-specific details in [Iframe Integration](/integration/).
...
- Planning runtime architecture: [Overview](/overview/).
- Planning iframe integration: [Iframe Integration](/integration/).
