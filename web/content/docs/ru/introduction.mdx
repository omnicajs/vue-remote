...
Транспорт-независимую схему смотрите в разделе [Обзор](/ru/overview/), а iframe-специфику в [Интеграция через iframe](/ru/integration/).
...
- Если проектируете runtime-архитектуру: [Обзор](/ru/overview/).
- Если планируете iframe-интеграцию: [Интеграция через iframe](/ru/integration/).
